...
Αν θέλετε να αποφύγεται την εγκατάσταση μπορείτε να συνδεθείτε στο: https://genuine-begonia-3f202d.netlify.app/ το οποίο είναι άμεσα συνδεδεμένο με το repository.
